...
def report_gen(drip: DataDrip):
    ...
    seasons = pandas.DataFrame(drip.source[[season]].groupby(season).value_counts())
    ...
    return {
        ...
        "row_2": status.to_json(orient="split"),
        "row_3": [ep_range.values.tolist(), currently_airing.to_json(orient="split"), seasons.to_json(orient="split")]
    }
